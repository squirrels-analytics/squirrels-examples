...
def main(sqrl: sr.ParametersArgs) -> None:
    ...
    # TODO: Child parameter from source
    ...
    """ Number and NumberRange Parameters """
    ...
    query = "SELECT 0 as min_value, round(max(amt)/10)*10 as max_value, 10 as increment FROM transactions WHERE is_fraud = '1'"
    ...
    sr.NumberRangeParameter.CreateSimple("between_filter", "Amounts Between", 0, 1000, default_lower_value=10, default_upper_value=400)

    # TODO: CreateFromSource example with NumberRangeParameter
